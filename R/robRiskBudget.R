...
#' a risk budget appears. However,in the general case,if we want to bound \deqn{\sigma_i} between
#' \deqn{\sigma_i^U} and \deqn{\sigma_i^L}, we either have to solve a full mean-variance optimization
