...
#' is returned. This is the enhanced version of \code{fitFfm} as we can fit a
#' multifactor model and include the fundamental law of active management in the
#' parameter \code{z.score}.
#'
#' @details
...
#'
#' @references
#' Ding, Z. and Martin, R. D. (2016). “The Fundamental Law of Active
#' Management Redux”, SSRN 2730434.
#'
